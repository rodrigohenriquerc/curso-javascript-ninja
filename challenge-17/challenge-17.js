(function () {
  ...
  */
  ...
  console.log(text.replace(/Manuel Marques de Sousa/g, 'Rodrigo Henrique Ramos de Carvalho'));
  ...
  */
  ...
  console.log(text.replace(/O Centauro de Luvas/, function (sentence) {
  ...
  */
  ...
  console.log(`O mês de ${month4} é representado pelo número ${getMonthNumber(month4)}.`);
  console.log(`O mês de ${month5} é representado pelo número ${getMonthNumber(month5)}.`);
